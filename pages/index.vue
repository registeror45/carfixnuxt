...
<template>
	...
	<link rel="icon" href="~/assets/image/IcoL.ico" type="image/x-icon"/>

	<nav clas=Navbar>
		<div class="Container">
			<a href="/" class="Navbar-Logo"><img src="~/assets/image/Logo.jpg" style="width:160px; height:100px"/></a>
	...
	<div class="DivImage">
		<img src="~/assets/image/MainPageImage.jpg" style="width:100%; height:100%; object-fit: cover;"/>
	<div class="PageInfoFooter">
		<img src="~/assets/image/scrol.png" style="width:50px ; height:45px" />
	</div>
	</div>
...
<div class="CancerBody" v-if="basket.length > 0" style="transition: opacity 0.3s ease;">
	<div class="Cancer"><img id="CancerImage" alt="" src="~/assets/image/CancerImage.png" @click="isModalOpen = true" /></div>
</div>
<Teleport to="body">
...
<div class="AboutUsOllContent">
	<div class="AboutUsContent">
		...
		<div class="AboutUsLogo"><img class="AboutUsImage" src="~/assets/image/Logo.jpg"/></div>
		</div>
	</div>
</div>	
</div>
