...
const productPrice = ref<number | null>(null); // Теперь productPrice имеет тип number
...
const addToBasket = async () => {
    ...
    if (!productName.value || productPrice.value === null || !productImage.value) {
    ...
    try {
        await axios.post(`${apiBaseUrl}/api/baskets/add`, {
            ...
            'items-price': productPrice.value,       // Используем productPrice (теперь число)
    ...
    <div class="PageProductBody">
        <div class="PageProductContent">
            ...
            <div class="PageImageProduct">
                <img style="width: 100%; height:100%; object-fit: cover;" src="~/assets/image/ProductImage.png" />
            </div>
            ...
            <div class="PageProductRightBlock">
                <div class="PageProductText">
                    ...
                    <div class="PagePriceForOne">formatPrice({{ productPrice }})/1шт</div>
                    <div class="PageButtonProductAdd">
                        <button class="PageBtnProductAdd">Добавить в карзину</button>
                    </div>
                </div>
                <!-- Блок с описанием -->
